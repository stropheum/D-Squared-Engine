...
#pragma endregion
		 ...
		 */
		virtual void Reserve(const std::uint32_t& capacity) = 0;
		 ...
		 * @Exception: Thrown if called from this context
		 */
		virtual void SetStorage(std::int32_t* data, const std::uint32_t& size);
		 ...
		 * @Exception: Thrown if called from this context
		 */
		virtual void SetStorage(float* data, const std::uint32_t& size);
		 ...
		 * @Exception: Thrown if called from this context
		 */
		virtual void SetStorage(glm::vec4* data, const std::uint32_t& size);
		 ...
		 */
		virtual void SetStorage(Scope** data, const std::uint32_t& size);
		 ...
		 * @Exception: Thrown if called from this context
		 */
		virtual void SetStorage(std::string* data, const std::uint32_t& size);
		 ...
		 * @Exception: Thrown if called from this context
		 */
		virtual void SetStorage(Library::RTTI** data, const std::uint32_t& size);
		 ...
		 * @Exception: Thrown if called from this context
		 */
		virtual std::string ToString(const std::uint32_t& index = 0);
