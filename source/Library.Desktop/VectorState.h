...
namespace Library
{
	class VectorState : public TypeState
	{
...
#pragma region Construction/Copy/Assignment
		...
		VectorState& operator=(const VectorState& rhs) = delete;

		VectorState(VectorState&& rhs) = delete;

		VectorState& operator=(VectorState&& rhs) = delete;
...
#pragma endregion
		 ...
		 */
		void SetStorage(glm::vec4* data, const std::uint32_t& size) override;
